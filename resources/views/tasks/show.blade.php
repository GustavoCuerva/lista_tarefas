            ...
            <div class="card-body">
                ...
                <form action="/tasks/update/{{$task->id}}" method="post">
                    ...
                    @if($task->done == 1)
                        ...
                        <input type="submit" name="button" id="button" class="btn btn-primary" style="background-color: red; border: none;" value="Desfazer">
                    @else
                        <p><strong>Status: </strong> Pendente</p>
                        <input type="hidden" name="done" value="1">
                        <input type="submit" name="button" id="button" class="btn btn-primary" value="Feito">
                    @endif
